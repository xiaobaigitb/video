...
public class Mail {
	...
	private static String myEmailAccount = "251145912@qq.com";//修改为自己的qq邮箱账号 kbxqqmovnvgdbidh
	private static String myEmailPassword = "kbxqqmovnvgdbidh";//修改为自己的邮箱授权码 prjburpwqcvtbihb   zxhhyxktjhjgbjhc
	private static String myEmailSMTPHost = "smtp.qq.com";//如果用qq邮箱不用修改，如果用163邮箱，修改为smtp.163.com
	private static String sendUser = "IT_Video系统";
