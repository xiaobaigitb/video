        ...
        <div style="float: right;">
            <form class="form-inline" action="admin/video/index.do" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="queryName" value="${query.queryName }"
                           placeholder="视频标题">
                </div>
                <div class="form-group">
                    <select name="speakerId" class="form-control">
                        ...
                        <c:forEach items="${speakers }" var="sp">
                            <option
                                    <c:if test="${query.speakerId==sp.id }">selected</c:if>
                                    value="${sp.id }">${sp.speakerName }</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <select name="courseId" class="form-control">
                        ...
                        <c:forEach items="${courses }" var="c">
                            <option
                                    <c:if test="${query.courseId==c.id }">selected</c:if>
                                    value="${c.id }">${c.courseName }</option>
                        </c:forEach>
                    </select>
                </div>
            ...
            <c:if test="${not empty pageInfo }">
                <c:forEach items="${pageInfo.results }" var="sp" varStatus="i">
                    <tr>
                        ...
                        <td><a href="admin/video/edit.do?id=${sp.id }"><span class="glyphicon glyphicon-edit"
...
<form id="pageForm" action="admin/video/index.do" method="post">
