...
<%--&lt;%&ndash;<li><a href="#">视频管理</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;<li class="active"><a href="#about">主讲人管理</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;<li><a href="#contact">课程管理</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div><!--/.nav-collapse -->&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--</nav>--%>
...
<div class="container">
    ...
    <form class="form-horizontal" action="admin/speaker/add.do" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerHeadUrl" id="speakerHeadUrl"
